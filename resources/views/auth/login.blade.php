...
<head>
    ...
    <style>
        .auth-one-bg {
            background-image: url("{{ asset('assets/Yobe-SUBEB-logo.jpg') }}");
...
<body>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="{{ route('home') }}" class="d-inline-block auth-logo">
                                    <img src="{{ asset('assets/Yobe-SUBEB-logo.jpg') }}" alt="" height="80">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">YOBE STATE SUBEB</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Yobe State SUBEB portal.</p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Yobe State SUBEB. Crafted with <i class="mdi mdi-heart text-danger"></i> by NeoTech
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- particles js -->
    <script src="{{ asset('themes/velzon') }}/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script src="{{ asset('themes/velzon') }}/js/pages/particles.app.js"></script>
    <!-- password-addon init -->
    <script src="{{ asset('themes/velzon') }}/js/pages/password-addon.init.js"></script>
</body>
